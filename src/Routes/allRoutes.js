...
import AddLevel from "../Components/TeacherPages/AddLevel";
import AddStudent from "../Components/SudentPages/AddStudent";
import StudentsTable from "../Components/TeacherPages/StudentsTable";
import Quiz from "../Components/SudentPages/Quiz";
import RabbitExercice from "../Components/SudentPages/RabbitExercice";
import QcmDetails from "../Components/TeacherPages/QcmDetails";
...
const authProtectedRoutes = [
  ...
  { path: "/qcm-details/:id", component: <QcmDetails /> },
  { path: "/students-table", component: <StudentsTable /> },
